...
> <div className="container flex items-center justify-between mx-auto px-4 lg:px-8"> <Link
       href="/"
...
/>
      ...
      <div className="hidden sm:flex flex-col">
        ...
        <span className="text-red-500 text-xs uppercase tracking-widest">
    ...
    <div className="hidden md:flex items-center space-x-8">
      ...
      <Link
        href="/resume.pdf"
        target="_blank"
        className="px-5 py-2 rounded-xl bg-red-600 hover:bg-red-700 transition-all text-white font-semibold"
      >
        Resume
      </Link>
    </div>
    ...
    <div className="absolute top-full left-0 w-full bg-[#050505]/95 backdrop-blur-2xl border-b border-white/10 md:hidden">
      <div className="container mx-auto px-6 py-8 flex flex-col space-y-2">
        ...
        <Link
          href="/resume.pdf"
          target="_blank"
          className="mt-4 px-4 py-3 rounded-xl bg-red-600 text-center text-white font-semibold"
        >
          Download Resume
        </Link>
      </div>
